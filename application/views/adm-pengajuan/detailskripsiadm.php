            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title text-center">Detail Skripsi</h4>
                            </div>
                            <div class="content">
                                <div class="row">
                                  ...
                                  <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="jeniskel">Penguji1</label>
                                        <input type="text" class="form-control" placeholder="" value="Drs. Syahputra Dinata / Web Development" disabled>
                                  ...
                                  <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="jeniskel">Penguji2</label>
                                        <input type="text" class="form-control" placeholder="" value="Drs. Syahputra Dinata / Web Development" disabled>
                                  ...
                                  <div class="col-md-12">
                                    <div class="row">
                                      <div class="col-md-5 col-md-offset-1">
                                        <div class="form-group">
                                            <label for="jeniskel">Tanggal Diterima</label>
                                            <input type="text" class="form-control" placeholder="" value="25 Maret 2018" disabled>
                                        </div>
                                  </div>
                                   <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="jeniskel">Tanggal Pengajuan</label>
                                                <input type="text" class="form-control" placeholder="" value="13 Maret 2018" disabled>
                                            </div>
                                        </div>
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-md-10 col-md-offset-1">
                                    <br>
                                    <a class="btn btn-danger btn-fill pull-right" href="/skripsi/adm-pengajuan" role="button">Kembali</a>
                                    <br>
                                  </div>
                                </div>
                            </div>
