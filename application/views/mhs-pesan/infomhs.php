    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="content">
                     <a type="button" rel="tooltip" href="/skripsi/pesan/tambah" title="Tulis Pesan" class="btn btn-info btn-fill abu"><i class="fa fa-plus"></i> Pesan</a>
                     <a type="button" rel="tooltip" href="/skripsi/pesan" title="Refresh" class="btn btn-default btn-fill abu"><i class="fa fa-refresh"></i> Refresh</a>
