...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h4 class="title">Detail Pegawai</h4>
                </div>
                <div class="content">
                  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                      <a href="/skripsi/adm-pegawai" class="btn btn-fill btn-danger pull-right abu" role="button"><i class="fa fa-chevron-circle-left"></i>Kembali</a>
                  </div>
