    ...
    <div class="content">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="content">
                <?php echo form_open_multipart(base_url('adm-pesan/tambahpesan'),'id="FormTambah", onsubmit="return validateForm()"'); ?>
                <div class="form-group">
                  <label class="pesan">Kepada</label>
                  <input type="text" name="nim" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="NIM MAHASISWA">
                </div>
                <div class="form-group">
