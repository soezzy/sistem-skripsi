    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="header">
                    <h4 class="title text-center">Daftar Validasi Pengajuan Skripsi Mahasiswa</h4>
                </div>
                <div class="content">
                        ...
                        <tbody>
                            ...
                            $rowCount = 1;
                                ...
                                <td class="td-actions text-center">
                                    <a type="button" rel="tooltip" href="<?php echo base_url('adm-validasi/detail/'.$value->idskripsi);?>" title="Validasi" class="btn btn-info btn-fill">
